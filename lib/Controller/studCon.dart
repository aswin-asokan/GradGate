...
class studCont {
  ...
  Future<Map<String, dynamic>> addStud() async {
    final String url =
        'http://localhost/Flutter/Api/student.php?action=addStud'; // Replace with your PHP script URL
  ...
  Future<Map<String, dynamic>> jobList() async {
    try {
      final String url =
          'http://localhost/Flutter/Api/student.php?action=jobList';
...
// retrieve student details
  Future<Map<String, dynamic>> stdDetails() async {
    try {
      final String url =
          'http://localhost/Flutter/Api/student.php?action=stdDet';
      // Get user ID from shared preferences
      SharedPreferences prefs = await SharedPreferences.getInstance();
      String? userId = prefs.getString('userId') ?? 'no value';
  ...
  Future<Map<String, dynamic>> viejobList() async {
    try {
      final String url =
          'http://localhost/Flutter/Api/student.php?action=viewJob';
      // Get user ID from shared preferences
      SharedPreferences prefs = await SharedPreferences.getInstance();
      String? userId = prefs.getString('userId') ?? 'no value';
  ...
  Future<Map<String, dynamic>> applyJob() async {
    final String url =
        'http://localhost/Flutter/Api/student.php?action=apply'; // Replace with your PHP script URL
  ...
  Future<Map<String, dynamic>> offUpdate(int app_id, int op) async {
    try {
      final String url =
          'http://localhost/Flutter/Api/student.php?action=offerUp';
      // Get user ID from shared preferences
  ...
  Future<Map<String, dynamic>> delAcc(String password) async {
    try {
      final String url =
          'http://localhost/Flutter/Api/student.php?action=delAcc';
      // Get user ID from shared preferences
      SharedPreferences prefs = await SharedPreferences.getInstance();
      String? userId = prefs.getString('userId') ?? 'no value';
