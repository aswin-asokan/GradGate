...
select * from students where company=name

String imgLink = "assets/images/no-profile-picture-15258 (1).png";
String nameOrCompany = "Google";
String depOrType = "Software";
String locationOrCollege = "America";
String mail = "mail";
String phone = "phone";
Document about = Document();*/
