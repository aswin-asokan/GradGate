...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 17, 2025 at 09:21 AM
...
(5, 127, 'FISAT', 'Ernakulam, Kerala, India', '9638527410'),
(6, 130, 'cusat ernakulam', 'Ernakulam, Kanayannur, Ernakulam, Kerala, 682035, India', '9874561234');
...
(36, 132, 'flysoft@gmail.com', 'Flysoft', 'Software solutions', 'Germany', '[{\"insert\":\"**About FlySoft**\\r\\n\\r\\nAt FlySoft, we are committed to elevating businesses through innovative and efficient software solutions tailored to meet the unique needs of each client. As a trusted technology partner, we specialize in providing end-to-end solutions that empower companies to optimize processes, enhance productivity, and achieve digital transformation.\\r\\n\\r\\nOur team of skilled professionals brings extensive experience in software development, web and mobile applications, cloud solutions, and data analytics. With a client-centered approach, FlySoft ensures that every solution is seamlessly aligned with the goals and vision of our partners, delivering reliable, scalable, and future-ready technologies.\\r\\n\\r\\n**Our Expertise:**\\r\\n- **Custom Software Development:** Tailored software solutions that streamline operations and drive business growth.\\r\\n- **Web & Mobile App Development:** High-quality, user-friendly applications that enhance engagement and accessibility.\\r\\n- **Cloud Solutions:** Scalable and secure cloud infrastructures to improve flexibility and reduce costs.\\r\\n- **Data Analytics & AI:** Data-driven insights and AI-powered solutions to enhance decision-making and business intelligence.\\r\\n- **Consulting & Support:** Comprehensive consulting and support services to ensure seamless implementation and long-term success.\\r\\n\\r\\nFlySoft is driven by a passion for excellence and a commitment to delivering value and innovation. We are dedicated to helping businesses harness the full potential of technology, turning ideas into impactful solutions that drive results.\\n\"}]', '5843136131', 'assets/images/no-profile-picture-15258 (1).png');
...
(23, 36, 'Android developer', '[{\"insert\":\"Skills:\\nKotlin\"},{\"insert\":\"\\n\",\"attributes\":{\"list\":\"ordered\"}},{\"insert\":\"Android studio\"},{\"insert\":\"\\n\",\"attributes\":{\"list\":\"ordered\"}},{\"insert\":\"Firebase\"},{\"insert\":\"\\n\",\"attributes\":{\"list\":\"ordered\"}}]', 30000, 'Full Time', 'CSE,AIML,DS', 'Android developer', '2024-11-13 00:00:00', 'Active');
...
(12, 128, 17, 'krishna', '11111111', 1, 'CSE', 0, '[{\"insert\":\"skills:programming html,css\\nlang known:python,c,c++\\n\"}]', 'https://coveringtaxes.com/wp-content/uploads/2024/04/AdobeStock_646904227-scaled.jpeg');
...
(127, 'fisat@gmail.com', '$2y$10$coTOKMJnznTX2w97dDsHnOnWYSOWd8sSXgM3nE6u.s21Vt7F3Cz3m', 'College'),
(128, 'krishna@gmail.com', '$2y$10$IjkTWuDvLHCsEA3hkpOYcePWHdsZTU0OFI2pE/LnGJnV3Bjc3ZaDC', 'Student'),
(130, 'custat@mail.com', '$2y$10$tLoNQj/nUMP7vzkXxucm6.e7JxL03xC8xtazJvphLZ4iTYKZRCKHC', 'College'),
(131, 'flysoft@mail.com', '$2y$10$IaI5p2BvY1xTQwFp9pC2qu/Gp/QUm79JeohqiUstN9A/McAqioTGG', 'Employer'),
(132, 'flysoft@gmail.com', '$2y$10$o0Si7S6xUQvKRqaAirG8T.avvbWlTBTdwQgP4QQHJqxxq5Zhm89Au', 'Employer');
...
--
ALTER TABLE `colleges`
  MODIFY `clg_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `employer`
--
ALTER TABLE `employer`
  MODIFY `eid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;
